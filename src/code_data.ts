...
`
  },
  {
    ...
    description: "Defines the primary ResearchItem schema using Pydantic, ensuring rigid, validated datatypes for technical feeds, AI summary records, and verifications.",
    content: `"""
...
`
  },
  {
    ...
    name: "__init__.py",
    description: "Initializes the models package and exposes the ResearchItem model cleanly.",
    content: `"""
